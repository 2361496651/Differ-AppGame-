...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStylePlain target:self action:@selector(cancelButtonDidClick)];
...
//    NSLog(@"%@",groupName);
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"共%ld张",groupCount];
