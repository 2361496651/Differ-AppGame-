...
//  iOS公共宏的定义
//
//  Created by 米线 on 13-8-8.
//  Copyright (c) 2013年 米线. All rights reserved.
//
...
#define ImgName(name, type) [[UIImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:name ofType:type]]
#define iOS7_Frama_Y (isIOS7?64:44)
#define isIOS7 ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0)
#define ios7control(h) (isIOS7?h+20.0:h)
#define isSystemVersioniOS8Plus (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"8.0"))
#define iPhone6 ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(750, 1334), [[UIScreen mainScreen] currentMode].size) : NO)
#define iPhone6Plus ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1242,2208), [[UIScreen mainScreen] currentMode].size) : NO)
#pragma mark - 获取设备 View大小
//-------------------获取设备大小-Begin------------------------
#define ScreenMultiple                      ScreenWidth/320
...
#define TherelativePositionX(view)          view.frame.origin.x+view.frame.size.width
#define TherelativePositionY(view)          view.frame.origin.y+view.frame.size.height
